...
class TestingConfig(object):
    def __init__(self):
        self.wlast = '/mnt/lustre/qiudi/relight_tf/Experiment_taxo/training_2019-12-22-12-47_relight_taxo_nohl_env/models/-300000'
...
class RelightLearner(object):
    ...
    def _build_graph(self):
       ...
       # RGB encoder
            rgb_input = tf.concat([self.rgb_input, self.conf, self.pc], 3)
